...
<Info>
Kombify has one hosted identity: one Auth0 Universal Login at
`login.kombify.io` and one Kombify account across every product. No hosted app
runs its own provider or asks customers to create another product account.
</Info>
