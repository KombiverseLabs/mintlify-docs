...
# SSH into each node (use the host and ports returned by the API)
ssh -p 30001 root@<your-sim-host>  # node-1
ssh -p 30002 root@<your-sim-host>  # node-2
ssh -p 30003 root@<your-sim-host>  # node-3
```
