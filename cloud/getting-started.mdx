...
- A kombify TechStack installation
- A kombify Cloud account at [app.kombify.io](https://app.kombify.io)

<Note>
Self-hosted TechStack is planned — the OSS mirror is not yet published. Managed TechStack instances are available through kombify Cloud.
</Note>
