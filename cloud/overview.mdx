...
<Tabs>
  <Tab title="Self-hosted">
    **You manage everything:**
    ...
    <Note>
    Self-hosting today means deploying StackKits yourself. A self-hosted TechStack release is planned — the OSS mirror is not yet published.
    </Note>
  </Tab>
...
| **Configuration** | kombify Cloud | So you can access it from anywhere |
| **User accounts** | kombify Cloud | Managed securely by Auth0 |
| **Deployment history** | kombify Cloud | Track who changed what, when |
...
See [Team management](/cloud/team-management) for the full permission matrix.
...
Current prices are listed at [kombify.io/pricing](https://kombify.io/pricing).
...
<AccordionGroup>
  ...
  <Accordion title="Compliance" icon="clipboard-check">
    ...
    - GDPR compliant
    - EU-hosted (EU data residency)
  </Accordion>
</AccordionGroup>

## Self-Hosted vs Cloud

| Feature | Self-Hosted (StackKits) | Managed (Cloud) |
|---------|---------------------|------------------|
| **Cost** | Free | Free tier + paid plans ([pricing](https://kombify.io/pricing)) |
...
<CardGroup cols={2}>
  ...
  <Card title="Getting Started" icon="download" href="/cloud/getting-started">
    Connect your homelab to kombify Cloud
  </Card>
