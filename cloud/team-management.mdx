...
Single Sign-On is available on Team plans (OIDC) and Enterprise plans (OIDC and SAML, with custom IdP onboarding). Supported providers include Okta, Azure AD (Entra ID), Google Workspace, and any OIDC-compliant provider; IdP groups map to Cloud roles.

See [Enterprise](/cloud/enterprise#enterprise-sso) for how enterprise SSO onboarding works.
