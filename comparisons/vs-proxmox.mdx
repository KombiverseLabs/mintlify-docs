...
**Using both together:** Proxmox handles node-level failures (hardware issues), while kombify's `ha` add-on handles service-level resilience.
...
<CardGroup cols={2}>
  ...
  <Card title="Already have Proxmox?" icon="server" href="/guides/self-hosting/overview">
