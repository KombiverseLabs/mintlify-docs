...
On Android, dictation from the SpeechKit keyboard still writes what you say
...
- **Android app** — press to talk, hear the answer, and watch the transcript
  ...
  keyboard, so you can hold a conversation without leaving the text field.
  Dictation keeps writing into the field; the conversation stays out of it.
