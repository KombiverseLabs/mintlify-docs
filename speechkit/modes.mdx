...
<CardGroup cols={2}>
  ...
  <Card title="Connect Microsoft Foundry" icon="microsoft" href="/speechkit/microsoft-foundry">
    Serve dictation, speech, Assist, and the Voice Agent from one Foundry project.
  </Card>
</CardGroup>
