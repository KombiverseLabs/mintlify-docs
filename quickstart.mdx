...
<Steps>
  <Step title="Open tool launcher">
    From the dashboard, click **"Launch TechStack"** in the tool launcher.
  </Step>

  <Step title="Choose deployment mode">
    Select **"Managed"** to use Cloud's hosted TechStack instance.
    
    <Note>
      **Managed:** TechStack runs in the cloud, your data stays on your server.
      **Self-hosted:** You run TechStack yourself — see [self-hosted quickstart](/quickstart-selfhosted).
    </Note>
  </Step>

  <Step title="Access TechStack">
...
<Steps>
  ...
  <Step title="Test your services">
    ...
    |---------|-----|---------------|
    | **Traefik** | `http://127.0.0.1:8080` | Dashboard loads, routing configured |
    | **Uptime Kuma** | `http://127.0.0.1:3001` | Monitoring UI accessible |
    | **Immich** | `http://127.0.0.1:2283` | Photo upload works |
  </Step>
