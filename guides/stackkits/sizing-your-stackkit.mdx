...
| ------------ | ----------------------------------------------------------------- | ----------------------------------- |
| 1            | One homelab server, VPS, or mini PC.                              | Basement Kit or Cloud Kit           |
| 2            | Split local/cloud, staging/production, or storage/app separation. | Basement/Cloud Kit or Modern Homelab; enough for the `warm-standby` HA tier |
| 3+           | Quorum, failover, or multiple critical services.                  | Modern Homelab or the [`ha` add-on](https://docs.kombify.io/stackkits/addons/high-availability) (`quorum` tier) |
...
- `1` usually points to the Basement Kit (or the Cloud Kit for a VPS).
- `2` depends on environment and use cases.
- `3+` raises Modern Homelab or the [`ha` add-on](https://docs.kombify.io/stackkits/addons/high-availability) as a direction.
