...
The Basement and Cloud Kit contracts expose `files` as an optional workload for the [Files](/guides/stackkits/use-cases/files) use case; the [use-case catalog](/stackkits/reference/use-case-catalog) lists the components declared by the published release. This selection was validated and generated with the released CLI:
