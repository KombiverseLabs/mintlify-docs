...
Dozzle is a real-time Docker container log viewer. It is **enabled by default** in the Base Kit so you can tail any service's logs from the browser without SSH.
