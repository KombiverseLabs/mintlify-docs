...
<Tip>
  Start with a base kit and add what you need — you can add add-ons later without rebuilding your stack. See the full catalog and per-capability alternatives in [tool alternatives](/stackkits/reference/tool-alternatives).
</Tip>
