...
<ClientSetupGuide
  ...
  steps={[
    ...
    },
    {
      ...
      clicks: [
        ...
        "In [[Name]], enter your name. The other people in your household see it.",
        "Click [[Continue]].",
      ],
    ...
    },
    {
      ...
      screenshot: { src: "/images/guides/passwords/vaultwarden/web-03-master-password.webp", width: 1088, height: 1268, alt: "Set a strong password page with the master password entered twice and rated Strong", caption: "Set a strong password", credit: "kombify screenshot", creditHref: "#kcg-passwords-sources", version: "Vaultwarden 1.37.2 · web vault 2026.7.0", captured: "2026-09-24", annotations: [{ n: 1, top: 26.3, left: 16.4, width: 60.7, height: 7.6 }, { n: 2, top: 53.9, left: 16.4, width: 60.7, height: 7.6 }, { n: 3, top: 89.8, left: 14, width: 72.1, height: 7.9 }] },
    },
    {
      tab: "First password",
      ...
      screenshot: { src: "/images/guides/passwords/vaultwarden/web-04-new-login.webp", width: 1472, height: 1484, alt: "New Login window with the item name Example Shop, a username and a generated password", caption: "New Login", credit: "kombify screenshot", creditHref: "#kcg-passwords-sources", version: "Vaultwarden 1.37.2 · web vault 2026.7.0", captured: "2026-09-24", annotations: [{ n: 2, top: 36.8, left: 7.9, width: 82.6, height: 6.5 }, { n: 3, top: 70.1, left: 7.9, width: 79.3, height: 6.5 }, { n: 3, top: 81.8, left: 87.5, width: 5.7, height: 5.7 }, { n: 4, top: 91.1, left: 2.7, width: 10.4, height: 6.7 }] },
    },
    {
      tab: "Connect apps",
      ...
      faq: { q: "Why is there no picture of the app here?", a: "Bitwarden does not allow its content to be reused on other websites. Its own guide shows each screen, and the labels above match it." },
  ...
  help={[
    ...
    { q: "The address does not open, or the browser warns about the connection.", a: "Try the address on a device in your home network first. If your vault runs only at home, connect to that Wi-Fi or to the private access you set up. Your device must trust your home server's certificate; the person who set up kombify can add your device. Do not click past certificate warnings. [About home addresses](/guides/stackkits/use-cases/network)." },
  ...
  attribution="**Vaultwarden runs your vault, and the Bitwarden apps open it. kombify helps you deploy it.** kombify makes neither app. [Vaultwarden](https://github.com/dani-garcia/vaultwarden) · [Vaultwarden license, AGPL-3.0](https://github.com/dani-garcia/vaultwarden/blob/main/LICENSE.txt) · [Bitwarden](https://bitwarden.com/)"
  sources={{
    summary: "Screenshots by kombify from a local Vaultwarden install · made-up account · English menus.",
    paragraphs: [
      "**Screenshots · September 24, 2026.** kombify captured the web vault pictures from a local reference install: Vaultwarden 1.37.2, the image the StackKits catalog delivers for Passwords, with web vault 2026.7.0. The install used the example address https://vault.home.test and the made-up account alex@example.com. It is a reference install, not a StackKits rollout test. This guide added the violet markers.",
      "The Bitwarden app screens are not shown. [Bitwarden's terms](https://bitwarden.com/terms/) do not permit reuse of its content, so step 5 links to Bitwarden's own guide.",
