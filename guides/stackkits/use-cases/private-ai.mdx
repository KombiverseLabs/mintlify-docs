...
<Info>
  Evidence state (2026-09-14, v0.31.x): Private AI is experimental. The current
  public release declares its components (Ollama and Open WebUI), and no
  released-archive runtime evidence exists yet for install, apply, verify,
  backup, or restore. Runtime evidence is pending.
</Info>
