...
<Info>
  ...
  the guest-local loopback. Photos (Immich) was last verified through restore
  activation on v0.33.3 and Vault (Vaultwarden) on v0.33.2; neither has a
  v0.35.0 run yet, and their application-level readback after restore is
  pending. Phone, second-device, and LAN acceptance are pending.
</Info>
