...
<AccordionGroup>
  ...
  <Accordion title="Is kombify free?">
    ...
    StackKits are open source today. Self-hosting for TechStack is **planned** (the open-source mirror is not yet published) and self-hosted Simulate is **coming soon** — see the [self-hosting overview](/guides/self-hosting/overview) for current status. kombify Cloud provides the managed experience.
...
<AccordionGroup>
  <Accordion title="How do I install kombify TechStack?">
    ...
    [Self-hosting guide →](/guides/self-hosting/overview)
  </Accordion>
  ...
  <Accordion title="How do I add a new node?">
    ...
    [Detailed guide →](/techstack/overview)
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Agent won't connect to Stack">
    ...
    **Debug steps:**
    ...
    [Full troubleshooting →](/techstack/reference/troubleshooting)
  </Accordion>
  ...
  <Accordion title="Deployment fails with validation error">
    ...
    **To debug:**
    ...
    # See detailed schema
    kombify schema show basement-kit
    ```
  ...
  <Accordion title="Services not accessible after deployment">
    ...
    **Quick test:**
    ...
    # Test local access
    curl -H "Host: myservice.home.local" http://127.0.0.1
    ```
  </Accordion>
