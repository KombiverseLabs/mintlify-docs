...
<Note>
  The self-hosted Simulate distribution is not yet published — self-hosting is coming soon. This quickstart describes the intended local flow. See [Self-hosting Simulate](/sim/how-to/self-hosting) for status.
</Note>
...
# Credentials are generated per node — shown in the node's connection details
