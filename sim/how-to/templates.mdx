...
Simulate includes pre-built templates for common homelab scenarios. Templates define node configurations, networking, and initial setup.
...
1. Open the Simulate dashboard (`http://127.0.0.1:5270` on a local install)
