...
1. **Foundation Layer** — Operating system / host configuration, security hardening, networking
...
- **Add services** — Include additional services beyond the kit's defaults
- **Customize layers** — Modify foundation or platform settings for your environment
