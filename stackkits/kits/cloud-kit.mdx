...
>>>>>>> origin/docs/stackkits-adr0026-wave1
...
<Note>
  Cloud Kit shares roughly 90% of its definition with the local Basement Kit (internally paired as "Basement Kit" for the local/pi context). Only the context-derived defaults differ — TLS, access model, and domain requirement. See [Relationship to the Basement Kit](#relationship-to-the-base-kit) below.
=======
