...
Since v0.24.63, the default core runs workloads with Docker Compose and installs neither Coolify nor Komodo. The core keeps routing and TLS, owner identity, secrets custody, status, update, and backup and restore. Platform managers are optional integrations selected explicitly; see [Application delivery](/guides/stackkits/application-delivery).
