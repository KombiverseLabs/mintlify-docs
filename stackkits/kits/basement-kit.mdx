...
Basement Kit is the current local profile of the published StackKits release. The [use-case catalog](/guides/stackkits/use-cases/overview) lists the components the published release declares. Use it for a homelab on hardware you already control, with one home site and a local owner.
