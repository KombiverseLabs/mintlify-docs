...
Basement Kit is the supported local profile of the current public StackKits release (v0.31.x). The [use-case catalog](/guides/stackkits/use-cases/overview) lists the components the published release declares. Use it for a homelab on hardware you already control, with one home site and a local owner.
