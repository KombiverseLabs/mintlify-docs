...
|---------|-----------|---------|
| **local** | Physical hardware, no cloud metadata | Self-signed TLS, local DNS on your chosen `network.domain.base` |
...
| | local | cloud | pi |
|---|---|---|---|
| **basement-kit** | Coolify, service URLs derived from `network.domain.base` | — | Lean profile, reduced services |
