...
Cloudreve is the default alternative inside the optional `files` workload contract. It is not enabled by the initial StackSpec; select the workload deliberately after planning storage and backups. The [use-case catalog](/guides/stackkits/use-cases/overview) lists the components the published release declares.
