...
- Create the application owner only after StackKits verification succeeds. Since StackKits v0.24.2, `stackkit setup files` verifies the administrator from a private credential file. See [Set up the application owner](/stackkits/reference/day-2-operations#set-up-the-application-owner).
