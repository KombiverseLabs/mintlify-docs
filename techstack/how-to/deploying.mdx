...
<CardGroup cols={2}>
  <Card title="Monitoring" icon="chart-line" href="/techstack/reference/monitoring">
    Monitor your deployed infrastructure
  </Card>
  <Card title="Drift detection" icon="arrows-rotate" href="/techstack/reference/troubleshooting">
