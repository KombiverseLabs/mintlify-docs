...
account-free local path, and the open-source
[Techstack Open Core control plane](/techstack/self-host) is self-hostable
with Docker Compose. The hosted entry at
...
<CardGroup cols={2}>
  ...
  <Card title="Self-host the control plane" icon="server" href="/techstack/self-host">
    Run Techstack Open Core on your own host with Docker Compose.
  </Card>
